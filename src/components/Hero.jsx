  ...
  return (
    <>
      ...
      <div className="relative z-20 w-full max-w-[1280px] px-4 sm:px-6 lg:px-8 flex flex-col items-start gap-6">
        <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-primary text-xs font-bold uppercase tracking-wider">
        ...
        <div className="flex flex-wrap gap-4 mt-4">
          <button className="flex items-center gap-2 h-11 sm:h-12 px-5 sm:px-6 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/30 text-white text-sm sm:text-base font-bold transition-all">
            Explore Our Vision
          ...
          >
            ...
            <div className="space-y-4">
              <a 
                ...
                className="flex items-center gap-4 p-4 rounded-xl border-2 border-gray-200 dark:border-[#2A453A] hover:border-primary hover:bg-primary/5 transition-all group"
              >
